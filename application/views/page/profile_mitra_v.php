                ...
                <div class="media p-md-5">
                        <?php 
                            if($data_session['photo_profile'] == ''){
                                ...
                                echo '<img class="align-self-center mr-5 rounded-circle" style="width:200px;height:200px;object-fit:cover" src="'.base_url()."uploads/mitra/profile/".$dataMitra->mitra_photo.'">';
                            }
                        ?>
                        ...
                        <div class="media-body">
                            <h5 class="mt-0 color-red"><?= $dataMitra->mitra_name; ?> <?php if($data_session['status_verif'] == 1){ ?><i class="fa fa-check-circle" style="color:#009923;"></i><?php } ?></h5>
