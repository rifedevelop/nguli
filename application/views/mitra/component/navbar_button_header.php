        ...
        <div class="row">
            <div class="col-6 mx-auto">
                <ul class="nav nav-tab-nguli nav-justified border-0">
                    ...
                    <a href="<?=site_url('mitra/ongoing_project');?>" class="nav-item shadow d-flex justify-content-center align-items-center bg-white color-red rounded p-4 my-2 mx-3">
                        <img src="<?=base_url('asset/img/button-ongoing.png');?>" class="pr-3" style="width: 30%">
                        <?=$this->lang->line('o-project');?>
                    </a>
                    <a href="<?=site_url('customer/last_project');?>" class="nav-item shadow d-flex justify-content-center align-items-center bg-white color-red rounded p-4 my-2 mx-3">
