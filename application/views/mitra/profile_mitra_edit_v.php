...
<div class="py-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 mx-autos row px-4">
                <div class="shadow bg-white py-5 px-4">
                    <h4 class="text-center mb-5">Verifikasi data diri</h4>
                    <?= form_open_multipart('mitra/save_verif','class="needs-validation" novalidate'); ?>
                        <div class="form-row px-1">
                            ...
                            <div class="col-md-12 row mb-4">
                                ...
                                <div class="col-md-4" data-toggle="modal" data-target="#img-popup" data-img="<?= base_url('uploads/mitra/nik/'.$dataUser->img_ktp);?>">
                            ...
                            <div class="col-md-12 row mb-4">
                                ...
                                <div class="col-md-4" data-toggle="modal" data-target="#img-popup" data-img="<?= base_url('uploads/mitra/npwp/'.$dataUser->img_npwp);?>">
                            ...
                            <div class="col-md-12 row mb-4">
                                ...
                                <div class="col-md-4" data-toggle="modal" data-target="#img-popup" data-img="<?= base_url('uploads/mitra/kk/'.$dataUser->img_kk);?>">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" name="nik" class="form-control" id="nik" placeholder="3990909xxxx" value="<?=$dataUser->nik;?>" <?=$disabled;?> required>
                            </div>
                            <div class="col-md-12 mb-4">
                                <label for="npwp">NPWP</label>
                                <input type="text" name="npwp" class="form-control" id="npwp" placeholder="3990909xxxx" value="<?=$dataUser->npwp;?>" <?=$disabled;?> required>
                            </div>
                            
                        </div>
                        <input type="hidden" name="id" value="<?= md5((string)$dataUser->user_id);?>" >
                        <input type="hidden" name="name" value="<?= $dataUser->name;?>" >
                        <button class="btn bg-red text-white px-4 float-right mt-5" type="submit" <?=$disabled;?> >Simpan</button>
                    <?= form_close(); ?>
