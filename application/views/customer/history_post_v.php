                        ...
                        <?php foreach ($dataPost as $key => $val) : ?>
                            <tr class="mb-3 shadow-sm bg-white">
                                ...
                                <td class="">
                                    <div class="d-flex align-items-center justify-content-start">
                                        ...
                                        <div class="d-flex flex-column align-self-center justify-content-start text-left">
                                            <p class="h6 font-weight-bold m-0"><?=$val->name;?></p>
                                ...
                                <td class="align-middle">
                                    <a href="<?=site_url('customer/detail_post/'.md5((string)$val->id));?>" class="btn bg-red text-white" style="border-radius: 1.5rem;padding: 3px 25px">Lihat Detail</a>
