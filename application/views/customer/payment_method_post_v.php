                    ...
                    <div class="row px-4 py-4 pb-5 mb-3">
                        <div class="col-md-12">
                            ...
                            <div class="d-flex justify-content-between">
                                <p>Subtotal</p>
                                <p>IDR <?=number_format($_SESSION['payment_post']['post_subtotal'],0,",",".");?></p>
                            </div>
                            <!-- <div class="d-flex justify-content-between">
                                <p>PPN</p>
                                <p>IDR </p>
                        ...
                        <div class="col-md-12 text-center mt-3">
                            ...
                            <input type="hidden" name="post_id" value="<?=$_SESSION['payment_post']['post_id'];?>">
                            <input type="hidden" name="total" value="<?=$_SESSION['payment_post']['post_subtotal'];?>">
