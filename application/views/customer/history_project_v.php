    ...
    <div class="container-fluid">
        <div class="row my-3">
            <div class="col-12">
                <a href="<?=site_url('customer/profile');?>">
                    <h4 class="color-red poppins-bold"><i class="fa fa-arrow-left mr-3 text-body" aria-hidden="true"></i> Riwayat Proyek</h4>
                </a>
            </div>
        </div>
        ...
        <?php
            if(empty($data_transaction)){
                echo "<div class='col-12 col-md-12 py-5 my-3'><h6 class='d-flex justify-content-center color-gray'>Tidak ada riwayat proyek!</h6></div>";
            } else {
                        ...
                        <div class="card-header" id="heading<?=$key;?>">
                                ...
                                <div class="d-flex justify-content-between align-item-center p-3">
                                    ...
                                    <div class="align-self-center pr-5">
                                            <?php
                                                switch ($valTrans->done) {
                                                    case '1':
                                                        echo "<span class='badge badge-success px-3 py-2'>Done</span>";
                                                        break;
                                                    
                                                    default:
                                                        echo "<span class='badge badge-warning px-3 py-2'>Progress</span>";
                                                    break;
                                            }
                                        ?>
                                    </div>
