                ...
                <div class="media p-md-5">
                    <?php 
                        if($data_session['photo_profile'] == ''){
                            ...
                            echo '<img class="align-self-center mr-5 rounded-circle" style="width:200px;height:200px;object-fit:cover" src="'.base_url()."uploads/customer/profile/".$data_session["photo_profile"].'">';
                        }
                    ?>
                    <div class="media-body ml-3">
                        <div class="d-flex flex-column">
                            <span class="mb-3"><h5 class="mt-0 color-red"><?php echo $data_session['name']; ?> 
                            <?php if($data_session['status_verif'] == 1){ ;?>
                            <i class="fa fa-check-circle" style="color:#009923;"></i>
                            <?php } ?></h5></span>
                            <span class="mb-1"><i class="fa fa-map-marker"></i> Jakarta Timur</span>
                            <span class="color-yellow mb-1"><i class="fa fa-map-marker"></i> Grade A+ <i class="fa fa-star"></i> 5.0</span>
                            ...
                            <span><a href="<?=site_url('customer/edit_profile');?>" class="btn bg-red text-white" style="border-radius: 1.5rem;padding: 3px 25px"><i class="fa fa-pencil-square-o pr-2"></i> <?=$this->lang->line('c-profile');?></a></span>
                        </div>
                    </div>
                </div>
            </div>
