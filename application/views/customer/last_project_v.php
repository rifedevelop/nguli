		...
		<div class="row my-5 font-size-13">
			...
			<div class="col-md-9">
				<div class="d-flex justify-content-start shadow rounded p-3 h-100">
					<div>
						<img class="align-self-center mr-5 rounded-circle" style="width: 25%;object-fit:cover" src="<?=base_url("asset/img/profil-pic-dummy.png");?>">
					</div>
					<!-- <div class="d-flex flex-column pr-5">
						<span class="color-gray mb-2">ID</span>
						<span>123</span>
					</div> -->
					<div class="d-flex flex-column pr-5" style="width: 30%">
					...
					<div class="d-flex flex-column">
						...
						<span><?=date("M, d Y", strtotime($valProj->est_date_fr));?></span>
					</div>
				</div>
			</div>
			<div class="col-md-3">
