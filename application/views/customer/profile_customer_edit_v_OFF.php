                ...
                <?= form_open_multipart('customer/save_profile','class="needs-validation" novalidate'); ?>
                    <div class="form-row px-4">
                        <div class="col-md-12 mb-5 d-flex justify-content-center">
                            <!-- <img class="w-25 rounded-circle" src="https://mdbootstrap.com/img/Photos/Avatars/avatar-5.jpg" alt="Generic placeholder image"> -->
                            <?php if($dataUser->photo == null){ ?>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="text" name="nik" class="form-control" id="nik" placeholder="NIK" value="<?=$dataUser->nik;?>" required>
                        </div>
                        <div class="col-md-12 mb-4">
                            <label for="npwp">NPWP</label>
                            <input type="text" name="npwp" class="form-control" id="npwp" placeholder="NPWP" value="<?=$dataUser->npwp;?>" required>
                        </div>
                        <div class="col-md-12 row mb-4">
