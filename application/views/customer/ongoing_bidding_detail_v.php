    ...
    <div class="container-fluid">
        ...
        <div class="row px-4 pb-5 mb-3 border-bottom">
            ...
            <div class="col-md-6">
                <div class="d-flex flex-column">
                    <h4 class="poppins-bold mt-0 mb-2">
                        <?= 
                    ...
                    <div class="d-flex flex-row align-items-center">
                        <?php if($dataProject->customer_photo == NULL) { ?>
                            <img src="<?=base_url("asset/img/profil-pic-dummy.png");?>" width="40" height="40" style="object-fit: cover;" class="rounded-circle align-self-center mr-3">
                        <?php } else { ?>
                            <img src="<?=base_url('uploads/customer/profile/'.$_SESSION['data_session']['photo_profile']);?>" width="40" height="40" style="object-fit: cover;" class="rounded-circle align-self-center mr-3">
                        <?php } ?>
                        ...
                        <p class="align-self-center"><?=$dataProject->customer_name;?></p>
                    </div>
                </div>
            </div>
        ...
        <div class="border border-secondary" style="background:#E6EEF7;">
            <div class="row px-4 py-4 pb-5 mb-3">
                <div class="col-md-12">
                    <h4 class="poppins-extra-bold pt-3 mb-5">Penawaran oleh Kontraktor Lain</h4>
                            ...
                            <?php foreach ($dataBidMitra as $key => $valBidMitra) : ?>
                                <tr class="mb-3">
                                    <td class="align-middle w-25">
                                        <a href="<?=site_url('profile?id='.md5((string)$valBidMitra->mitra_id));?>">
                                            <div class="d-flex flex-row">
                                                <?php if($valBidMitra->mitra_photo == NULL) { ?>
                                                    <img src="<?=base_url("asset/img/profil-pic-dummy.png");?>" width="40" height="40" style="object-fit: cover;" class="rounded-circle align-self-center mr-3">
                                                <?php } else { ?>
                                                    <img src="<?=base_url('uploads/mitra/profile/'.$valBidMitra->mitra_photo);?>" width="40" height="40" style="object-fit: cover;" class="rounded-circle align-self-center mr-3">
                                                <?php } ?>
                                                <!-- <img src="https://mdbootstrap.com/img/Photos/Avatars/avatar-5.jpg" width="40" height="40" class="rounded-circle align-self-center mr-3"> -->
                                                <p class="h6 align-self-center" style="color:#549EFF"><?=$valBidMitra->mitra_name;?></p>
                                            </div>
                                        </a>
                                    </td>
