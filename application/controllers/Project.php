...
class Project extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($ceksession['type_user'] == 'mitra') {
            $data['main'] = 'mitra/project_v';
        } else if ($ceksession['type_user'] == 'customer') {
            $data['main'] = 'customer/project_v';
        } else {
    ...
    public function page()
    {
        ...
        if ($ceksession['type_user'] == 'mitra') {
            $data['main'] = 'mitra/project_v';
        } elseif ($ceksession['type_user'] == 'customer') {
            $data['main'] = 'customer/project_v';
        } else {
            $data['main'] = 'page/project_v';
        }
    ...
    public function detail()
    {
        ...
        if ($ceksession['type_user'] == 'mitra') {
            $data['main'] = 'mitra/project_detail_v';
        } else if ($ceksession['type_user'] == 'customer') {
            $data['main'] = 'customer/project_detail_v';
        } else {
